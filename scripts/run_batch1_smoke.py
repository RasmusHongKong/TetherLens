...
def main() -> None:
    ...
    resolvers = [SearchIndexedToolMassResolver(search_provider)] if search_provider else []
    runner = IngestionRunner(fetcher, resolvers=resolvers)
    records: list[dict] = []
    ...
    payload = {
        ...
        "search_provider": search_provider.name if search_provider else None,
        "results": records,
        "summary": summary,
    }
